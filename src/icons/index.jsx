...
export function UserGroupIconAlt({ className = null }) {
    return (
        <svg
            ...
            className={className}
        >
            <circle cx="9" cy="7" r="3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path
        ...
        >
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path
                    ...
                    strokeLinejoin="round"
                />
                <path d="M20.7249 9.25H15.7751M18.25 6.77515L18.25 11.7249" strokeWidth="2" strokeLinecap="round" />
            </g>
        </svg>
    );
}
...
export function ThumbsUpIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="0.625rem" width="0.625rem" fill="#fff">
...
export function PenIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="0.875rem" width="0.875rem">
